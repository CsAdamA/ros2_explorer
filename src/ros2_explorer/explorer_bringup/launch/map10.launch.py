...
def generate_launch_description():
    ...
    #nav2_launch_file_dir = r'/workspaces/navigation_ws_humble1/src/turtlebot3/turtl3bot3_navigation2/launch'
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([r'/workspaces/navigation_ws_humble2/src/ros2_explorer/explorer_navigation2/launch', '/navigation2.launch.py']),
            launch_arguments={'use_sim_time': use_sim_time}.items(),
        ),
